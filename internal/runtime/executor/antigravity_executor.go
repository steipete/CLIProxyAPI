...
const (
	// Eviction closes idle connections while preserving active requests. Bounding cached
	// credential pools also bounds how many independently sized idle pools can survive churn.
	antigravityTransportCacheCapacity = 128
